...
== Базовые понятия реляционных БД, свойства отношений.
Основные понятия --- тип данных, домен, атрибут, кортеж, первичный ключ и отношение.

*ДОПИСАТЬ С ПРЕЗЕНТАЦИИ ОПРЕДЕЛЕНИЯ.*
...
_Объяснение._ Говорят, что отношение _R_ находится в 1НФ, если оно удовлетворяет определению 2. *ДОПИСАТЬ ОПРЕДЕЛЕНИЕ*
